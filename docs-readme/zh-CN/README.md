...
<table align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border: none !important;">
  ...
  <tr>
    ...
    <td valign="top" width="50%" style="border: none !important;">
      • <a href="../../src/fine-tune/models/gemma4/gemma4_emotion_lora_modelscope_single_gpu.ipynb">Gemma4 - E4B LoRA微调（基于TRL）</a><br>
    </td>
  </tr>
  <tr>
...
&emsp;&emsp;参与前请先阅读 **[Content Guide](../../CONTENT_GUIDE_en.md)**（目录、命名、配图与文档结构与 **Qwen3** 等教程对齐），再阅读 **[CONTRIBUTING_en.md](../../CONTRIBUTING_en.md)**（Issue / PR 流程与模型专项目录约定）。
